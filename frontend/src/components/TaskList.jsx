...
import DatePicker from "react-datepicker";  // ✅ FIX: Import DatePicker
...
const TaskList = () => {
  ...
  const [renamingColumnId, setRenamingColumnId] = useState(null); // Add this line
  ...
  const createBoard = async (boardName) => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/api/tasks/columns/create", {
        userId,
        columnName: boardName, // Use the passed boardName
      });
      ...
      setNewBoardCreateName(""); // Clear the input field
      setIsAddingBoard(false); // Close the input field
      setIsDropdownOpen(null);
    } catch (error) {
  ...
  const renameBoard = async (columnId, newName) => {
    ...
    try {
      ...
      setIsDropdownOpen(null); // Close the dropdown menu
    } catch (error) {
                ...
                {isAddingBoard ? (
                  <div className="add-board-wrapper">
                    <input
                      ...
                      value={newBoardCreateName} // Use newBoardCreateName
                      onChange={(e) => setNewBoardCreateName(e.target.value)} // Update newBoardCreateName
                      autoFocus
                    />
                    <div className="button-container">
                      <button
                        className="tick-btn"
                        onClick={() => {
                          createBoard(newBoardCreateName); // Pass newBoardCreateName
                          setNewBoardCreateName(""); // Clear the input after creation
                        }}
                      >
                        ✔️
                      </button>
                      <button
                        ...
                        onClick={() => {
                          ...
                          setNewBoardCreateName(""); // Clear the input
                        }}
                      >
                        ❌
                      </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setNewBoardCreateName(""); // Reset the input field
                    }}
                  >
      ...
      {isModalOpen && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="modal-left">
                ...
                <textarea
                  ...
                  value={newTaskTitle}
                  onChange={(e) => setNewTaskTitle(e.target.value)} // 🔥 Removed height-changing logic
                />
            ...
            {/* 🔥 Move Description Below Both Sections */}
