...
describe("DeleteConfirmationModal", () => {
  ...
  test("displays correct message for task deletion", () => {
    const expectedMessage = 'Are you sure you want to delete the task:<br>"Test Task"?';
    const { container } = render(
    ...
    const messageElement = container.querySelector(".delete-confirmation-text");
    expect(messageElement.innerHTML).toBe(expectedMessage);
  });

  test("displays correct message for column deletion without tasks", () => {
    const expectedMessage = 'Are you sure you want to delete the board:<br>"Test Board"?';
    const { container } = render(
      <DeleteConfirmationModal
        {...defaultProps}
        entityType="column"
  ...
  test("displays correct message for column deletion with tasks", () => {
    const expectedMessage = 'Are you sure you want to delete the board:<br>"Test Board"?<br><br>All tasks inside will also be deleted!';
    const { container } = render(
      <DeleteConfirmationModal
        {...defaultProps}
        entityType="column"
